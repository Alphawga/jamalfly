...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://web.facebook.com/jamalflynigeria/',
      icon: (
    ...
    {
      name: 'Twitter',
      href: 'https://x.com/jamalflynigeria',
      icon: (
        <svg viewBox="0 0 24 24" className="h-6 w-6">
          <path
            fill="#000000"
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/jamalflynigeria/',
      icon: (
        <svg viewBox="0 0 24 24" className="h-6 w-6">
          <defs>
            <radialGradient
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/jamalnigeria/',
      icon: (
        <svg viewBox="0 0 24 24" className="h-6 w-6">
          <path
            fill="#0A66C2"
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@jamalflynigeria',
      icon: (
        <svg viewBox="0 0 24 24" className="h-6 w-6">
          <path
            fill="#FF0000"
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@jamalflynigeria',
      icon: (
        <svg viewBox="0 0 24 24" className="h-6 w-6">
          <path
            fill="#000000"
